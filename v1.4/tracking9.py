...
while True:
    ...
    if found:
        ...
        if cx >= 0.7*img.shape[1]:
            next_image_name, next_img, x_co, y_co, theta, fig = command_disp(100, annotations, images_path, cur_image_name, img, x_co, y_co, theta, fig, found) #rotate cw
            
        elif cx <= 0.3*img.shape[1]:
            next_image_name, next_img, x_co, y_co, theta, fig = command_disp(97, annotations, images_path, cur_image_name, img, x_co, y_co, theta, fig, found) #rotate cw
        ...
        if obstacle_side[0]:
            ...
            next_image_name, next_img, x_co, y_co, theta, fig = command_disp(115, annotations, images_path, cur_image_name, img, x_co, y_co, theta, fig, found) #backwards
            if next_image_name == '':
            ...
            if next_image_name == '':
                next_image_name = cur_image_name
                next_image_name, next_img, x_co, y_co, theta, fig = command_disp(97, annotations, images_path, cur_image_name, img, x_co, y_co, theta, fig, found) #rotate ccw
                left_rotation += 1
            ...
            if next_image_name == '':
                next_image_name = cur_image_name
                next_image_name, next_img, x_co, y_co, theta, fig = command_disp(direction, annotations, images_path, cur_image_name, img, x_co, y_co, theta, fig, found) 
                next_image_name, next_img, x_co, y_co, theta, fig = command_disp(direction, annotations, images_path, next_image_name, next_img, x_co, y_co, theta, fig, found) 
            else:
                next_image_name, next_img, x_co, y_co, theta, fig = command_disp(direction, annotations, images_path, cur_image_name, img, x_co, y_co, theta, fig, found) 
                next_image_name, next_img, x_co, y_co, theta, fig = command_disp(direction, annotations, images_path, next_image_name, next_img, x_co, y_co, theta, fig, found) 
    ...
    if next_image_name != '':
        ...
        direction = random.choice([97,100])
        for i in range(4):
            cur_image_name, img, x_co, y_co, theta, fig = command_disp(direction, annotations, images_path, cur_image_name, img, x_co, y_co, theta, fig, found) 
